@php
    $meta = [
        'title' => 'Edit Relationship Report',
        'description' => 'Update Relationship Report records in the Numerology software dashboard.',
        'keywords' => 'edit relationship report, numerology, relationship report, relationship compatibility, dashboard',
    ];
@endphp
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header border-light d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Update the required details to modify the Relationship record.
                        </p>
                    </div>
                ...
                <form method="post" action="{{ route('account.relationship.update', ['relationship' => $relationship->id]) }}"
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control only-string @error('first_name') is-invalid @enderror"
                                ...
                                value="{{ old('first_name', $relationship->first_name ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                ...
                                name="middle_name" value="{{ old('middle_name', $relationship->middle_name ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control only-string @error('last_name') is-invalid @enderror"
                                id="last_name" name="last_name" value="{{ old('last_name', $relationship->last_name ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" onclick="showPicker(this)"
                                ...
                                name="dob" value="{{ old('dob', $relationship->dob ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control only-email @error('name') is-invalid @enderror"
                                id="email" name="email" value="{{ old('email', $relationship->email ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <select name="phone_code" id="phone_code"
                                    ...
                                    @foreach (getAllCountries() as $country)
                                        <option value="{{ $country->id }}"
                                            {{ old('phone_code', $relationship->phone_code ?? '') ?? defaultCountry()['id'] == $country->id ? 'selected' : '' }}>
                                ...
                                <input type="text" value="{{ old('mobile_number', $relationship->mobile_number ?? '') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="gender" id="gender" class="form-select @error('gender') is-invalid @enderror">
                                ...
                                @foreach (getGenders() as $gend)
                                    <option value="{{ $gend['id'] }}" @selected(old('gender', $relationship->gender ?? '') == $gend['id'])>
                                        {{ $gend['name'] }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="text-end mt-4">
                        ...
                        <a href="{{ route('account.relationship.list') }}" class="btn btn-outline-secondary">
