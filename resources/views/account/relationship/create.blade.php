@php
    $meta = [
        ...
        'description' => 'Generate and manage Relationship Reports in the Numerology software dashboard.',
        'keywords' =>
            'relationship report, numerology, relationship compatibility, love compatibility, marriage compatibility, numerology report, relationship analysis, numerology software, dashboard',
    ];
@endphp
...
@section('content')
    <x-account.breadcrumb pageTitle="Manage Relationship Report" :lists="[
        route('account.relationship.list') => 'Relationship Report List',
        '' => 'Add Relationship Report',
    ]" />
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header border-light d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Enter the required details to create a new relationship report record.
                        </p>
                    </div>
                ...
                <form method="post" action="{{ route('account.relationship.store') }}" enctype="multipart/form-data"
