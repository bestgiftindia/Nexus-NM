        ...
        <div class="col-xxl-12">
            <div data-table data-table-rows-per-page="8" class="card">
                <div class="card-header border-light justify-content-between">
                    <div>
                        <h2 class="card-title d-block">Add User</h2>
                        <p class="text-muted mb-0">
                            Create a new user account and assign the appropriate role and permissions.
                        </p>
                    </div>
                ...
                <form method="post" action="{{ route('account.users.store') }}" enctype="multipart/form-data" class="card-body border-top">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" readonly style="cursor: no-drop"
                                ...
                                name="account_id" value="{{ generateUserId() }}" placeholder="Enter Account id">
                            @error('account_id')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <small class="text-muted ">(NOTE: If you leave the User Permissions section blank, the user will automatically inherit all permissions assigned to their selected role.)</small>
                            @error('permissions')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
