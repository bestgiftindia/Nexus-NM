@php
    $meta = [
        'title' => 'Dashboard',
        'description' => 'Access your numerology dashboard to manage profiles, generate numerology reports, analyze numbers, and explore personalized numerology insights.',
        'keywords' => 'numerology, numerology dashboard, numerology reports, numerology calculator, number analysis, personalized numerology, numerology software',
    ];
@endphp
                        ...
                        <div class="col-xxl-9 order-xl-3 order-xxl-1">
                            <div class="px-4 py-3">
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <a href="#!"
                                        class="link-reset text-decoration-underline fw-semibold link-offset-3">View Reports
            ...
            <div data-table data-table-rows-per-page="7" class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#!" class="btn btn-sm btn-soft-secondary"> <i data-lucide="plus" class="me-1"></i>
                            Add Product </a>
                        <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i data-lucide="download"
                                class="me-1"></i> Export CSV </a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Wireless
                                                        Earbuds</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 30px">
                                        <div class="dropdown">
                                            <a href="#"
                                                ...
                                                <i data-lucide="ellipsis-vertical" class="fs-xl"></i>
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Laptop
                                                        Stand</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Drone
                                                        Camera</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Portable
                                                        Projector</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Smartphone
                                                        G12</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Audio</span>
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Noise
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Mini Air
                                                        Purifier</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Accessories</span>
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">USB-C
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Gadgets</span>
                                                <h5 class="fs-base mb-0"><a href="#!" class="text-body">Digital
                                                        Photo Frame</a></h5>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-6">
            <div data-table data-table-rows-per-page="7" class="card">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a href="#!" class="btn btn-sm btn-soft-secondary"> <i data-lucide="plus"
                                class="me-1"></i> Add Product </a>
                        <a href="javascript:void(0);" class="btn btn-sm btn-primary"> <i data-lucide="download"
                                class="me-1"></i> Export CSV </a>
                    </div>
                </div>
