@php
    $meta = [
        ...
        'description' => 'Manage Loshu Grid reports in the Numerology software dashboard.',
        'keywords' => 'loshu grid, numerology, loshu report, dashboard',
    ];
@endphp
...
@section('content')
    <x-account.breadcrumb pageTitle="Manage Loshu Grid Mastery" :lists="[
        route('account.loshugrid.index') => 'Loshu Grid Mastery',
        '' => 'List',
    ]" />
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-light d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            View and manage all Loshu Grid reports.
                        </p>
                    </div>

                    <div>
                        <a href="{{ route('account.loshugrid.index') }}" class="btn btn-primary">
                ...
                <div class="table-responsive p-3">
                    <table data-tables="export-data-dropdown" data-url="{{ route('account.loshugrid.lists.data') }}"
